...
**MUST use the configured review-bridge skill (see `_bmad/automator/story-automator.yaml` → `reviewer.bridge`; default `bmad-story-automator-review`). Do NOT use a generic Task agent for reviews.** The examples below use the default; substitute your configured bridge name.
